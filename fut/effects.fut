...
let generate_shadowmap3 (color_fun : f32 -> f32 -> i32) (height_fun : f32 -> f32 -> f32) (ang : f32) (sun_dy : f32) : [][]i32 =
    let max_dist = 1024
...
let generate_shadowmap_accumulated (color_fun : f32 -> f32 -> i32) (height_fun : f32 -> f32 -> f32) (sun : [3]f32) : [][]i32 =
    let max_dist = 1024
...
let generate_shadowmap_weighted_nearest (color_fun : f32 -> f32 -> i32) (height_fun : f32 -> f32 -> f32) (sun : [3]f32) : [][]i32 =
    let max_dist = 1024
    let steps_per_ray = 256
    let step_size = f32.i32 (max_dist / steps_per_ray)
    in
